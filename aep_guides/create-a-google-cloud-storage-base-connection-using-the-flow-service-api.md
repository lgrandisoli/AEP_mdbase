...
created_at: "2026-06-26T17:36:41.837291+00:00"
---
...
This tutorial walks you through the steps to create a base connection for Google Cloud Storage using the [Flow Service API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
...
The path to the folder that you want to provide access to.
connectionSpec.id
The Google Cloud Storage connection specification ID:
