...
- Keeps only internal documentation links under /en/docs/analytics-platform/using/cja-overview
...
DEFAULT_START_URLS = [
    ...
    "https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2c-overview/cja-faq",
    "https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2c-overview/cja-vs-bi",
    "https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2c-overview/ai-assistant",
...
def main() -> None:
    ...
    # For CJA we do not want to drop pages just because their breadcrumb/category
    # does not match the generic taxonomy (many of these pages land in "other").
