...
created_at: "2026-06-02T19:08:45.771455+00:00"
---
...
You can filter the list of segments. Using a filter on segments makes it easier to find the segments that are available to you, and manage segments from the [Segment manager](/en/docs/analytics-platform/using/cja-components/segments/seg-manage).

NOTE
The list of segments refers to the
segment list
as part of the
Segment manager
. You can filter that list using the
Filter panel
, part of that same
Segment manager
.
...
- Select filters from any of the available filter sections . note info INFO Items refer to the filter items displayed in the Filter list .
...
The [Filter list](/en/docs/analytics-platform/using/cja-components/segments/seg-manage#segment-list) is automatically updated based on your filter configuration. You can see the configured filters in the [Active filter bar](/en/docs/analytics-platform/using/cja-components/segments/seg-manage#active-filter-bar).
