...
created_at: "2026-06-23T20:44:18.687321+00:00"
---
...
See [Data stories for Mobile scorecard projects](/en/docs/customer-journey-analytics-learn/tutorials/dashboards/create-a-mobile-scorecard#_blank) for a demo video.
...
- In a scorecard, click into a tile. For example, in this scorecard, click into the line graph at the bottom.
- Tap the blue icon at the top right to generate the captions. The captions will appear below the line graph.
- Swipe right to view all intelligent captions. Intelligent captions can point to data spikes, anomalies, trends, declines, correlations, and other phenomena.
- Tap the black flag inside a caption to report a problem, such as harmful or illegal content.
- Click the X to exit out of the Report results dialog.
