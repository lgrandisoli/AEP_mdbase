...
created_at: "2026-06-02T19:07:29.673708+00:00"
---
...
- Adobe Experience Platform Datasets​ Data prep​ Data Distiller​
- Customer Journey Analytics Connections​ Data views , including derived fields​ Segments​ Calculated metrics Guided analysis​: Timeline​
...
- [Guided analysis​: Active growth](/en/docs/analytics-platform/using/guided-analysis/active-growth)
- [Guided analysis: Net growth](/en/docs/analytics-platform/using/guided-analysis/net-growth)
- [Guided analysis: Trends](/en/docs/analytics-platform/using/guided-analysis/trends)
- [Attribution panel​](/en/docs/analytics-platform/using/cja-workspace/panels/attribution)
- [Freeform table](/en/docs/analytics-platform/using/cja-workspace/panels/freeform-panel) that includes the marketing channel dimension (creating using a [derived field](/en/docs/analytics-platform/using/cja-dataviews/derived-fields))
...
- [Guided analysis: Engagement](/en/docs/analytics-platform/using/guided-analysis/engagement)
- [Guided analysis: Trends](/en/docs/analytics-platform/using/guided-analysis/trends)
- [Guided analysis: Frequency](/en/docs/analytics-platform/using/guided-analysis/frequency)
- [Guided analysis: Funnel](/en/docs/analytics-platform/using/guided-analysis/funnel)
- [Guided analysis: Conversion trends](/en/docs/analytics-platform/using/guided-analysis/conversion-trends)
- [Guided analysis: Release impact](/en/docs/analytics-platform/using/guided-analysis/release-impact)
- [Guided analysis: First use impact​](/en/docs/analytics-platform/using/guided-analysis/first-use-impact)
- [Guided analysis: Timeline](/en/docs/analytics-platform/using/guided-analysis/timeline)
- [Freeform tables​](/en/docs/analytics-platform/using/cja-workspace/panels/freeform-panel)
...
- [Guided analysis: Retention](/en/docs/analytics-platform/using/guided-analysis/retention)​
- [Guided analysis: Active growth](/en/docs/analytics-platform/using/guided-analysis/active-growth)
- [Guided analysis: Net growth](/en/docs/analytics-platform/using/guided-analysis/net-growth)
...
- Create and publish audiences ​ for activation from Customer Journey Analytics
- Activate audiences through CX Enterprise products: Run experiments in AJO and Adobe Target, and measure the impact of variations in Customer Journey Analytics using the Experimentation panel Deliver in-app engagements to users in AJO
- Activate audiences to external destinations with Adobe Real-time CDP​
...
- [Share](/en/docs/analytics-platform/using/cja-workspace/curate-share/share-projects) guided analysis views tailored to specific business questions, enabling consumers to self-serve their next question
- Combine guided analyses, panels, and visualizations into a comprehensive dashboard in [Analysis Workspace](/en/docs/analytics-platform/using/cja-workspace/home)
- Create a [mobile scorecard](/en/docs/analytics-platform/using/cja-dashboards/home) with key product insights for Executives and other consumers on the go
