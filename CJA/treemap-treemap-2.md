...
created_at: "2026-06-23T20:43:21.770237+00:00"
---
...
*This article documents the Treemap visualization in* *Customer Journey Analytics .**See Treemap for the* *Adobe Analytics version of this article.*

style
shade-box
Use a **Treemap** visualization to display hierarchical (tree-structured) data as a set of nested rectangles.
...
See [Treemap visualization](/en/docs/customer-journey-analytics-learn/tutorials/analysis-workspace/visualizations/add-treemap-visualizations#_blank) for a demo video.
