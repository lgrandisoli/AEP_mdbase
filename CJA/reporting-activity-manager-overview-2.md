...
created_at: "2026-06-23T20:44:37.421540+00:00"
---
...
To manage reporting activity, you must have the Product Admin role. For more information, see [Customer Journey Analytics Access Control](/en/docs/analytics-platform/using/technotes/access-control).

## View reporting activity

For information about viewing reporting activity in the Reporting Activity Manager, see [View reporting activity in the Reporting Activity Manager](/en/docs/analytics-platform/using/reporting-activity-manager/reporting-activity).

## Cancel reporting requests

For information about cancelling reporting requests in the Reporting Activity Manager, see [Cancel reporting requests in the Reporting Activity Manager](/en/docs/analytics-platform/using/reporting-activity-manager/reporting-activity-cancel-requests).
