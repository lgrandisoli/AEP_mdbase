...
created_at: "2026-06-02T19:05:43.004201+00:00"
---
...
The [detailed use case article](/en/docs/analytics-platform/using/cja-usecases/b2b/b2b-edition/optimize-account-marketing) explores how Customer Journey Analytics B2B Edition can help to optimize account marketing.
...
The [detailed use case article](/en/docs/analytics-platform/using/cja-usecases/b2b/b2b-edition/grow-key-accounts) explores how Customer Journey Analytics B2B Edition can help to grow key accounts.
...
The [detailed use case article](/en/docs/analytics-platform/using/cja-usecases/b2b/b2b-edition/build-product-value) explores how Customer Journey Analytics B2B Edition can help to build product value.

## Setup

The [setup article](/en/docs/analytics-platform/using/cja-usecases/b2b/b2b-edition/setup) discusses how to set up Customer Journey Analytics B2B Edition to support these use cases.
