...
created_at: "2026-06-23T20:42:21.098908+00:00"
---
...
NOTE
You must have the Customer Journey Analytics
Select
package or higher (for
field-based stitching
) or the Customer Journey Analytics
Prime
package or higher (for
graph-based stitching
) to use the functionality described in this section. Contact your administrator if you’re unsure which Customer Journey Analytics package you have.
...
Customer Journey Analytics supports two types of stitching: [field-based stitching](/en/docs/analytics-platform/using/stitching/fbs) and [graph-based stitching](/en/docs/analytics-platform/using/stitching/gbs).
...
- Import the desired data into Adobe Experience Platform: For Adobe Analytics data, see Utilizing Adobe Analytics report suite data in Customer Journey Analytics . For other types of data, see Create a schema and Ingest data in the Adobe Experience Platform documentation.
...
Once your organization meets generic [prerequisites](/en/docs/analytics-platform/using/stitching/overview#prerequisites), understands common [limitations](/en/docs/analytics-platform/using/stitching/overview#limitations), and also stitching method specific ([field-based](/en/docs/analytics-platform/using/stitching/fbs) and [graph-based](/en/docs/analytics-platform/using/stitching/gbs)) prerequisites and limitations, you can follow these steps to request and start using stitching in Customer Journey Analytics.
...
Field-based stitching
Graph-based stitching
One-time stitching backfill duration
13 months
13 months
25 months
...
up to 7 days, weekly
1 day, every day
up to 14 days, weekly
1 day, every day
up to 30 days, weekly
Maximum number of datasets permitted for stitching
5
15
50
## Enable stitching
...
- [Request to enable stitching](/en/docs/analytics-platform/using/stitching/use-stitching) (deprecated). Once approved, a duplicate dataset is created for the dataset for which you have requested stitching. This duplicate dataset contains an additional column with the stitched identifier. You have to create a new or edit an existing connection that includes the stitched dataset to use the stitched data in Customer Journey Analytics.
- [Enable stitching in the Connections interface](/en/docs/analytics-platform/using/stitching/use-stitching-ui). When you configure stitching for a dataset in the Connections interface, the stitching occurs on the fly, during the ingestion of data from that dataset in Customer Journey Analytics.
