...
created_at: "2026-06-23T20:42:33.384560+00:00"
---
...
The Customer Journey Analytics B2B Editior uses the [Adobe Experience Data Model (XDM)](/en/docs/experience-platform/xdm/home) to standardize B2B data and define schemas for your B2B data. You can base your schemas on the [standard classes that are provided in Real-time CDP B2B Edition](/en/docs/experience-platform/rtcdp/schemas/b2b) or you can use your own custom classes and schemas. The [use cases](/en/docs/analytics-platform/using/cja-usecases/b2b/b2b-edition/use-cases-overview) articles use Real-time CDP B2B Edition classes and schemas, however, a Real-time CDP B2B Edition license is not required to utilize the standard classes and schemas.
