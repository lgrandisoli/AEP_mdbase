...
created_at: "2026-06-02T19:04:31.598511+00:00"
---
...
IMPORTANT
In all scenarios, the data you want to
use
in Customer Journey Analytics is actually
ingested
...
See [Ingest and use data from traditional Adobe Analytics](/en/docs/analytics-platform/using/cja-data-ingestion/ingest-use-guides/analytics) for more information.
...
See [Ingest and use data via the Adobe Experience Platform Web SDK](/en/docs/analytics-platform/using/cja-data-ingestion/ingest-use-guides/edge-network/aepwebsdk) for more information.
...
See [Ingest and use data via the Adobe Experience Platform Mobile SDK](/en/docs/analytics-platform/using/cja-data-ingestion/ingest-use-guides/edge-network/aepmobilesdk) for more information.
...
See [Ingest and use data via the Adobe Experience Platform Edge Network Server API](/en/docs/analytics-platform/using/cja-data-ingestion/ingest-use-guides/edge-network/serverapi) for more information.
...
See [Ingest and use batch data](/en/docs/analytics-platform/using/cja-data-ingestion/ingest-use-guides/batch) for more information.
...
See [Ingest and use streaming data](/en/docs/analytics-platform/using/cja-data-ingestion/ingest-use-guides/streaming) for more information.

## Ingest and use data using source connectors

You have data available from a source that is supported by a source connector. Source connectors are configurable configurations that allow you to ingest data from Adobe, first-party and third-party application into Adobe Experience Platform. See [Source connectors overview](/en/docs/experience-platform/sources/home) for an overview of available source connectors. Using the source connector you can easily ingest data from the source into Adobe Experience Platform and then use, combine and analyze it with data from other channels and data sources in Customer Journey Analytics.

See [Ingest and use data using source connectors](/en/docs/analytics-platform/using/cja-data-ingestion/ingest-use-guides/sources) for more information.
...
See [Ingest and use ad hoc data](/en/docs/analytics-platform/using/cja-data-ingestion/ingest-use-guides/adhoc)

Related Articles
Blog:
A Closer Look at Data Processing & Ingestion in Adobe Customer Journey Analytics
