...
created_at: "2026-06-02T19:08:02.936215+00:00"
---
...
The [Active growth](/en/docs/analytics-platform/using/guided-analysis/active-growth) guided analysis can help you to determine how to:
...
- [Create and configure an Active growth](/en/docs/analytics-platform/using/guided-analysis/active-growth) guided analysis.
- Select **Accounts** as **Counted as**.
- Select the preferred **Chart settings**. For example: **Stacked bar**.
- Select the preferred **Interval** and **Date range**.
...
A [Mobile scorecard](/en/docs/analytics-platform/using/cja-dashboards/home) can help to provide these insights.
...
- Define the period on which you want to report. For example October 2024 vs Previous Period .
- Drag and drop the relevant metrics onto the app canvas. For example: Global accounts , Opportunities , Closed-Won , Closed-Lost , Revenue Closed-Won , and Revenue-Closed-Lost .
- Use Preview to preview the dashboard. The dashboard is now available from the Adobe Analytics dashboard app, available from the App Store or Google Play .
